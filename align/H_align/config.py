...
arg.add_argument('--path_data',
                 type=str,
                 default='/data1/zhaoweiyue/benchmark-results/',
...
arg.add_argument('--path_visualization',
                 type=str,
                 default='/data1/zhaoweiyue/benchmark-visualization',
...
arg.add_argument('--method_dict', type=parse_json, default='H_align/matching.json', help='')
arg.add_argument('--dataset', type=str, default='phototourism', help='')
...
arg.add_argument('--task', type=str, default='stereo', help='')
